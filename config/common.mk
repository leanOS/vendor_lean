...
# Set all versions
LEAN_VERSION := leanOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(LEAN_BUILD_TYPE)$(LEAN_POSTFIX)
LEAN_MOD_VERSION := leanOS-$(LEAN_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(LEAN_BUILD_TYPE)$(LEAN_POSTFIX)
