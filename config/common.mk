...
# Set all versions
LEAN_VERSION := leanos-$(PRODUCT_VERSION_MAJOR)-$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(LEAN_POSTFIX)
LEAN_MOD_VERSION := leanos-$(LEAN_BUILD)_$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(LEAN_BUILD_TYPE)$(LEAN_POSTFIX)
